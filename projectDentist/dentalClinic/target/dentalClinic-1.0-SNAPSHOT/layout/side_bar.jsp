    ...
    <c:if test="${sessionScope.userRolType == 5}">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTurn"
               aria-expanded="true" aria-controls="collapseTurn">
                <i class="fa-solid fa-clipboard-list"></i>
                <span>Turn</span>
            </a>
            <div id="collapseTurn" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Turn's options</h6>
                    <a class="collapse-item" href="../ResponsibleController?action=show" name="action" value="verU" >See Turn</a>
                    <a class="collapse-item" href="../view/CreateResponsible.jsp">Create Turn</a>
                </div>
            </div>
        </li>
